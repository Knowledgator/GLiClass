...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', type=str, default= "models/gliclass/deberta_small_class/checkpoint-54000")
    parser.add_argument('--encoder_model_name', type=str, default = 'microsoft/deberta-v3-base')
    parser.add_argument('--save_path', type=str, default = 'models/gliclass/deberta_small_synt')
    parser.add_argument('--data_path', type=str, default = '../data/synthetic_cats1.json')
    ...
    parser.add_argument('--squeeze_layers', type=bool, default=True)
    parser.add_argument('--num_epochs', type=int, default=2)
    parser.add_argument('--batch_size', type=int, default=8)
    parser.add_argument('--encoder_lr', type=float, default=7e-6)
